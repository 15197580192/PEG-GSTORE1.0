 ...
 * @Description: a test to add edge
 */
#include <iostream>
#include <string>
#include <vector>
...
int main(int argc, char const *argv[])
{
    if(argc < 5)
    {
        ...
        cout << "./build/PEG_AddEdge database_name fromVertex perdicate toVertex" << endl;
        cout << "./build/PEG_AddEdge watdiv \<http://db.uwaterloo.ca/~galuc/wsdbm/User0\> \<test\> \<http://db.uwaterloo.ca/~galuc/wsdbm/User1\>" << endl;
    ...
    std::string sparql = "insert data { " + fromVertex + "  " + predicate + "   " + toVertex + " . }";
